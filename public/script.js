document.addEventListener('DOMContentLoaded', function() {
    ...
    const firebaseConfig = {
        apiKey: "AIzaSyAPuBUhWMWe8gB_sH-WfEMB88BYQr4_yFc",
        authDomain: "random-number-assessment.firebaseapp.com",
        projectId: "random-number-assessment",
        storageBucket: "random-number-assessment.firebasestorage.app",
        messagingSenderId: "536573908302",
        appId: "1:536573908302:web:e1361fe74bff62f5977a1f",
        measurementId: "G-GWSDSXGG0W"
    };
    ...
    const totalNumEntries = 100; // Increased from 20 to 100
    let tooSlow = false;
    ...
    function uploadCSVToDriveAutomatically(csvContent) {
        const base64Data = btoa(unescape(encodeURIComponent(csvContent))); // Convert CSV to Base64

        const functionUrl = "https://uploadcsvtodrive-2lift37kma-uc.a.run.app"; // Replace with your deployed function URL
        // const functionUrl = "https://<YOUR_PROJECT_ID>.cloudfunctions.net/uploadCSVToDrive";
    ...
    function endSession() {
        ...
        // prompt.innerHTML = `
        //     Thank you for completing the number task. 
        //     You have now also completed the Social Cognitive Strengths and Weakness study.
        //     <br><br>
        //     Your completion code is: <strong>C1047UNH</strong>
        //     <br><br>
        //     Please allow us up to one week to review your results. Once we review your results, you will be paid $5.00 directly through Prolific. 
        //     <br><br>
        //     Thank you for your participation!
        // `;
        prompt.innerHTML = `
                Thank you for completing the number task.<br>
                You may now close this link and return to the survey.<br>
                Please enter the following completion code into the survey: <strong>WXT2746</strong>
            `;
